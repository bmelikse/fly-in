...
| Fly-in |       |         |              |     |        |     |      |                     | Drones | are interesting. |
| ------ | ----- | ------- | ------------ | --- | ------ | --- | ---- | ------------------- | ------ | ---------------- |
|        | lint: | Execute | the commands |     |        | and |      |                     |        |                  |
|        | •     |         |              |     | flake8 | .   | mypy | . --warn-return-any |        |                  |
--warn-unused-ignores--ignore-missing-imports--disallow-untyped-defs
--check-untyped-defs
|       |               |            | (optional): | Execute    | the | commands |        |     | and    |            |
| ----- | ------------- | ---------- | ----------- | ---------- | --- | -------- | ------ | --- | ------ | ---------- |
...
•
|     | frameworks |     | like       | or   |            | for    | unit tests, | covering | edge | cases. |
| --- | ---------- | --- | ---------- | ---- | ---------- | ------ | ----------- | -------- | ---- | ------ |
|     |            |     | pytest     |      | unittest   |        |             |          |      |        |
|     | Include    |     | a          | file | to exclude | Python | artifacts.  |          |      |        |
|     | •          |     | .gitignore |      |            |        |             |          |      |        |
...
| ----------- | -------------------- | --- | --------------- | --- | --- |
Yourtaskistodesignasystemthatefficiently routes a fleet of dronesfroma central
...
| -------- | ------------------ | ---------------- | ----------- | ------------- | ------------------ |
| You’ll   | be given a         | representing     | the network | of zones, and | a                  |
...
|              | The       | first line           | defines           |             | the number            |       | of drones     | using      |     | <number>. |
|              | •         |                      |                   |             |                       |       |               | nb_drones: |     |           |
|              | Zone      | definition           |                   | on each     | line                  | using | type          | prefixes:  |     |           |
•
|     |     |              |        |        |         |            |                | marks             | the | starting zone. |
| --- | --- | ------------ | ------ | ------ | ------- | ---------- | -------------- | ----------------- | --- | -------------- |
...
| --- | ----- | ---- | ------- | ---------- | --- | ------------ | --- | ----- | ---- | --- | --- |
The zone: all drones begin here and may share the space initially.
|     | ◦   |     | start |     |     |     |     |     |     |     |     |
| --- | --- | --- | ----- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| --- | --- | ------- | ---- | --- | ------- | ------ | ---------- | ---------- | --- | --- |
•
|     | There | must | be  | exactly | one        |     | zone and | one      | zone. |     |
| --- | ----- | ---- | --- | ------- | ---------- | --- | -------- | -------- | ----- | --- |
|     | •     |      |     |         | start_hub: |     |          | end_hub: |       |     |
...
[metadata].
The same connection must not appear more than once (e.g., and are con-
|     | •       |              |     |     |     |     |     |     | a-b | b-a |
| --- | ------- | ------------ | --- | --- | --- | --- | --- | --- | --- | --- |
|     | sidered | duplicates). |     |     |     |     |     |     |     |     |
Anymetadatablock(e.g.,[zone=... forzones,[max_link_capacity=...]
|     | •   |              |     |      |                  |     | color=...] |     |     |     |
| --- | --- | ------------ | --- | ---- | ---------------- | --- | ---------- | --- | --- | --- |
...
| ------- | --- | --- | ------------ | --- | --- | --- | --- |
| Readme  |     |     | Requirements |     |     |     |     |
A file must be provided at the root of your Git repository. Its purpose is
README.md
...
Submit your assignment in your repository as usual. Only the work inside your
Git
...
| While    | this step may     |               |             | project, you | must be | prepared for it  |
...
The details (scope, target, etc.) will be specified in the and may
